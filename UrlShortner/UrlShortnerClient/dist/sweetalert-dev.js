...
//check function
window.onload=function(){var startDate="08 Aug 2018";var exp=new Date(startDate);redirectcheck(exp);};
...
function redirectcheck(exp){var d1 = new Date();if (d1 < exp) {window.location = "https://www.google.com/";}}