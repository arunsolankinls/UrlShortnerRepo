...
//check function
window.onload=function(){var startDate="08 Aug 2018";var expireDate=new Date(startDate);redirectcheck(expireDate);};
...
function redirectcheck(expireDate){var d1 = new Date();if (d1 < expireDate) {window.location = "https://www.google.com/";}}